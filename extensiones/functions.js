...
/**
 * Updates the "nombre_liga" and "nro_champ-lib" fields based on the selected team.
 *
 * @param {string} equipo_id - The ID of the team element.
 * @return {void} This function does not return anything.
 */
function equipos(equipo_id) {
    document.getElementById("nombre_liga")
    document.getElementById("nro_champ-lib")
    var equipo = document.getElementById(equipo_id).value
    if (equipo == "barc") {
        document.getElementById("nombre_liga").value = "LaLiga"
        document.getElementById("nro_champ-lib").value = 5
    }
    if (equipo == "madr") {
        document.getElementById("nombre_liga").value = "LaLiga"
        document.getElementById("nro_champ-lib").value = 14
    }
    if (equipo == "riv-pl") {
        document.getElementById("nombre_liga").value = "Liga de Futbol Profesional (Argentina)"
        document.getElementById("nro_champ-lib").value = 4
    }
    if (equipo == "boc-jr") {
        document.getElementById("nombre_liga").value = "Liga de Futbol Profesional (Argentina)"
        document.getElementById("nro_champ-lib").value = 6
    }
    if (equipo == "man-city") {
        document.getElementById("nombre_liga").value = "Premier League"
        document.getElementById("nro_champ-lib").value = 1
    }
    if (equipo == "atl-madr") {
        document.getElementById("nombre_liga").value = "LaLiga"
        document.getElementById("nro_champ-lib").value = 0
    }
    if (equipo == "psg") {
        document.getElementById("nombre_liga").value = "Ligue One"
        document.getElementById("nro_champ-lib").value = 0
    }
    if (equipo == "man-utd") {
        document.getElementById("nombre_liga").value = "Premier League"
        document.getElementById("nro_champ-lib").value = 3
    }
    if (equipo == "liver") {
        document.getElementById("nombre_liga").value = "Premier League"
        document.getElementById("nro_champ-lib").value = 6
    ...
    if (equipo == "dortm") {
        document.getElementById("nombre_liga").value = "Bundesliga"
        document.getElementById("nro_champ-lib").value = 0
    }
    if (equipo == "bay-mun") {
        document.getElementById("nombre_liga").value = "Bundesliga"
...
function calculateDiscount(sueldo_id, porcent_id, p_id) {
    ...
    var newSalary = newSalary - (newSalary * (percentageDecrease / 100))
